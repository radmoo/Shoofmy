...
const USE_CASES = [
  ...
  },
  {
    ...
    desc: "Une rue, une manifestation, une file d'attente, une situation inattendue… quelqu'un peut aller voir pour vous.",
  ...
  },
  {
    ...
    desc: "Allez voir l'endroit avant vous : l'ambiance, l'accès, le lieu… vous saurez à quoi vous attendre.",
